...
class OutputTransition(nn.Module):
    def __init__(self, inChans, elu, nll):
        ...
        self.conv1 = nn.Conv3d(inChans, 5, kernel_size=5, padding=2)
        self.bn1 = nn.BatchNorm3d(5)
        self.conv2 = nn.Conv3d(5, 5, kernel_size=1)
    ...
    def forward(self, x):
        ...
        out = out.permute(0, 1, 2, 3, 4).contiguous()
        
        # flatten
       # out = out.view(out.numel() // 5, 5)
